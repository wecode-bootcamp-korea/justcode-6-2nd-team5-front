      ...
      <div className="foot-bottom-text">
        <li className="first-p">
          <p>
            ...
            <span className="left-line"> 사업자등록번호 : 105-87-76000 사업자정보조회</span>
            <span className="left-line"> 통신판매신고 제2015-제주연동-43호</span>
            <span className="left-line"> 관광사업자 등록번호 : 제2021-08호</span>
          </p>
